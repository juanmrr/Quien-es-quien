...
public:
	...
	*/
	...
	/**
	  * @brief construye completamente el árbol, se usa como apoyo recursivo en crear arbol.
	  * 
	...
	/**
	  * @brief proporciona la información de la jugada recursivamente, se usa como apoyo recursivo de informacion_jugada.
	  * 
	...
	/**
	  * @brief Este método construye el árbol de preguntas con las preguntas más discriminatorias.
	  */

	bintree<Pregunta> crear_arbol_entropia();

	/**
	  * @brief construye completamente el árbol óptimo, se usa como apoyo recursivo en crear arbol entropia
	  * 
	...
	/**
	  * @brief devuelve la pregunta más óptima, el atributo más discriminatorio
	  * 
	  * @param numero_personajes que quedan.
	  * @param vector_posiciones vector con las posiciones de los personajes que quedan.
	  * @param preguntas_restantees vector con las preguntas que ya hemos hecho.
